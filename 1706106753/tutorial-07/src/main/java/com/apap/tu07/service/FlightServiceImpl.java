...
public class FlightServiceImpl implements FlightService {
	...
	public void updateFlight(Long flightId, FlightModel flight) {
		FlightModel newPilot = flightDb.getOne(flightId);
		
		newPilot.setDestination(flight.getDestination());
		newPilot.setOrigin(flight.getOrigin());
		newPilot.setTime(flight.getTime());
