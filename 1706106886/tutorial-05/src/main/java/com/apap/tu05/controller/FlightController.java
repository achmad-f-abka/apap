...
public class FlightController {
	 ...
	 * String licenseNumber, Model model) { FlightModel flight = new FlightModel();
	 * PilotModel pilot = pilotService.getPilotDetailByLicenseumber(licenseNumber);
	 * flight.setPilot(pilot); model.addAttribute("flight", flight); return
	 * "addFlight"; }
	 */
    ...
    public String deleteFlightById(@ModelAttribute PilotModel pilot, Model model) {
