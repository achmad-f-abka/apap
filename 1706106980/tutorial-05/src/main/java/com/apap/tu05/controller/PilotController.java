...
public class PilotController {
	...
	public String viewPilotId(@RequestParam(value = "licenseNumber", required = true) String licenseNumber, Model plt) {
		PilotModel pilot = pilotService.getPilotDetailByLicenseumber(licenseNumber);
		if (pilot != null) {
			List<FlightModel> flight = pilot.getPilotFlight();
			plt.addAttribute("pilot", pilot);
			plt.addAttribute("flight", flight);
