...
public class FlightServiceTest {
	...
	@TestConfiguration //membatasi scope Bean yg didefinisikan mjd local slass
	static class FlightSerivceTestContextConfiguration {
		@Bean//initiate flighService sbg Bean
	...
	public void whenValidFlightNumber_thenFLightShouldBeFound() {
		...
		//then
		assertThat(found.get(), Matchers.notNullValue());//to check if not null
		assertThat(found.get().getFlightNumber(), Matchers.equalTo(flightModel.getFlightNumber()));//to check if same
	}
