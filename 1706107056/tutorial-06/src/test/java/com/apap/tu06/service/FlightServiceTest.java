...
public class FlightServiceTest {
	...
	@TestConfiguration //Mengatasi scope Bean yang didefinisikan menjadi local class
	...
	public void whenValidFlightNumber_thenFlightShouldBeFound() {
		...
		assertThat(found.get().getFlightNumber(), Matchers.equalTo(flightModel.getFlightNumber())); // cehck if same
	}
