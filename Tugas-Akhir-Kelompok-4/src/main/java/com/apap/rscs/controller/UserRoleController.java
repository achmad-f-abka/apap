...
import com.apap.rscs.model.PasswordModel;
import com.apap.rscs.model.UserRoleModel;
import com.apap.rscs.repository.UserRoleDB;
import com.apap.rscs.service.UserRoleService;
...
public class UserRoleController {
    ...
    private String addUser(Model model) {
    	model.addAttribute("users", new UserRoleModel());
        return "addUser";
    }
